...
drop view F15E4executive_director_view
drop view F15E4lab_director_view
drop view F15E4lab_system_administrator_view
...
create view F15E4executive_director_view as
SELECT
	emp_id,
	emp_name,
	emp_lab,
...
create or replace TRIGGER F15E4executive_director_trigger
	INSTEAD OF insert ON F15E4executive_director_view
	FOR EACH ROW
BEGIN
	insert into F15E4emp(
		emp_id,
...
create view F15E4lab_system_administrator_view as
SELECT
	emp_id,
	emp_name,
	emp_lab,
...
create or replace TRIGGER F15E4lab_system_administrator_trigger
	INSTEAD OF insert ON F15E4lab_system_administrator_view
	FOR EACH ROW
BEGIN
	insert into F15E4emp(
		emp_id,
